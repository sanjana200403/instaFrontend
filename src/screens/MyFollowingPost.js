...
const MyFollowingPost = () => {
  ...
  // ======fetching all the my following posts=====
  fetch("https://instaclone-ball.onrender.com/myfollowingpost",{
    headers:{
  ...
  .then((result)=>{
    ...
    console.log(result,"ALLMY FOLLOWING POSTS DATA!!")
    })
  .catch((err)=>console.log(err,"ALL MY FOLLOWING ERROR"))
      ...
      <div className="card">
        ...
        <div className="card-header">
          <div className="card-pic">
            <img src={data.postedBy.Photo} alt="" />
          </div>
